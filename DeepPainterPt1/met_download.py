...
def download_lines(lines, out_dir, met_csv):
    ...
    with open(os.path.join(out_dir, "piece_info.csv"), 'wb') as csv_file:
        ...
        driver = webdriver.Chrome(executable_path="C:\\Users\\17073\AppData\Local\Temp\Temp1_chromedriver_win32.zip\chromedriver.exe")
        for line in lines:
            res = ""
            try:
...
# python met_download.py --csv = ./openaccess/MetObjects.csv --out = ./ArtDataSet --artist = "Edourd Manet": "Vincent van Gogh":"Johannes Vermeer": "Gustav Klimt":"Paul Gauguin": "Auguste Renoir":"Paul Cezanne"
    # "./openaccess/MetObjects.csv"
    # ./ArtDataSet
    # "Edourd Manet": "Vincent van Gogh":"Johannes Vermeer": "Gustav Klimt":"Paul Gauguin": "Auguste Renoir":"Paul Cezanne"
	types = []
	...
	met_csv = csv.reader(open(met_csv_file, 'r', encoding="utf8"), delimiter=',')
